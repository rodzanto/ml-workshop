...
- Machine Learning
  ...
  - [**Lab #1: Build, Train, and Deploy with Amazon SageMaker**](machine-learning/1-overview.md)
    ...
    - [Bring your own algorithms to SageMaker](machine-learning/sagemaker-byoa/1-step.md)
    - [SageMaker multi-model endpoints](machine-learning/sagemaker-multi-model/1-step.md)
    - [SageMaker Studio Autopilot](machine-learning/sagemaker-autopilot-studio/1-lab.md)
...
- Artificial Intelligence
  ...
  - [**Lab #2: Explore the AWS Artificial Intelligence Services**](artificial-intelligence/2-overview.md)
    - [Scene and face detection with Rekognition](artificial-intelligence/rekognition-face-analysis/01-lab.md)
